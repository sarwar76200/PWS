...
<body onload="add_doctor()" onclick="init()" onkeypress="upd_state()" onmouseover="upd_state()">
    ...
    <form action="" method="post">
        <div class="formHead">
            ...
            <input oninput="add_patient()" type="text" class="name" name="name" value="<?php echo ($REG_ID == -1 ? "" : $PAT_DATA[0]) ?>">

            <label for="">Age &emsp;&ensp;:</label>
            <input onchange="add_patient()" type="text" class="age" name="age" value="<?php echo ($REG_ID == -1 ? "" : $PAT_DATA[1]) ?>">

            <label for="">Sex &emsp;&emsp;:</label>
            <!-- <input type="text" class="name" name="name"> -->
            <select onchange="add_patient()" id="sex" class="sex" name="sex" value="<?php echo ($REG_ID == -1 ? "" : $PAT_DATA[2]) ?>">
            ...
            <input onchange="add_patient()" type="text" class="name" name="mobile" maxlength="11" value="<?php echo ($REG_ID == -1 ? "" : $PAT_DATA[3]) ?>">

            <label for="">Reg No.:</label>
            <input onchange="add_patient()" type="text" class="age" name="reg" id="Reg" value="<?php echo $patient_RegNo ?>" readonly>

            <label for="">Address&ensp;:</label>
            <input onchange="add_patient()" type="textarea" class="address" name="address" value="<?php echo ($REG_ID == -1 ? "" : $PAT_DATA[4]) ?>">

            <label for="">Date:</label>
            <input onchange="add_patient()" type="date" class="date" name="date" id="Date" value="<?php echo ($REG_ID == -1 ? "" : $PAT_DATA[5]) ?>">
        ...
        <div class="button">
            <input type="submit" value="Save" class="submit" name="submit_btn">
        </div>
                ...
                <script>
                    ...
                    function add_doctor() {
                        ...
                        const DOC_DATA = '<b style=""><font size="5">Dr. ' + doctor_name + '</font></b> <br/>' +
                            ...
                            '<font size="3">Phone: ' + '01715765340' + '</font> <br/>' +
